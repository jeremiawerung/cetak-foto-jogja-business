...
@section('title', 'Login Admin Katalog - Cetak Foto Jogja')

@section('content')
<div class="min-h-screen flex items-center justify-center px-4">
    <div class="w-full max-w-sm rounded-2xl border border-neutral-200 bg-white p-6 sm:p-8 shadow-sm">
        <h1 class="text-lg font-bold text-neutral-900">Login Admin Katalog</h1>
        <p class="mt-1 text-sm text-neutral-500">Akses khusus pengelola katalog cetak foto.</p>
